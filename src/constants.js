...
const API_KEY = `Basic eogergregdfr5589a`;
...
export {MOST_COMMENTED_FILMS_COUNT, TOP_RATED_FILMS_COUNT,
  MAIN_FILMS_COUNT_ON_START, MAIN_FILMS_COUNT_BY_BUTTON, ESCAPE_KEY, ENTER_KEY, API_KEY, URL, DONE_STATE, LOADING_STATE, NO_DATA_STATE};
