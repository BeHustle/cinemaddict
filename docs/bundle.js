...
/* harmony import */ var _models_comment_model__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../models/comment-model */ "./src/models/comment-model.js");
...
class API {
  ...
  getMovies() {
    return this._load({path: `movies`})
      ...
      .then(_models_movie_model__WEBPACK_IMPORTED_MODULE_0__["default"].parseMovies);
  }

  getComments(filmId) {
    return this._load({path: `comments/${filmId}`})
      .then((response) => response.json())
      .then(_models_comment_model__WEBPACK_IMPORTED_MODULE_1__["default"].parseComments);
  }
  ...
  updateMovie(id, data) {
    return this._load({
      ...
      .then((response) => response.json())
      .then(_models_movie_model__WEBPACK_IMPORTED_MODULE_0__["default"].parseMovie);
  }
...
class Provider {
  ...
  getMovies() {
    ...
    return Promise.resolve(_models_movie_model__WEBPACK_IMPORTED_MODULE_0__["default"].parseMovies(this._store.getMovies()));
  }
  ...
  getComments(filmId) {
    ...
    return Promise.resolve(_models_comment_model__WEBPACK_IMPORTED_MODULE_1__["default"].parseComments(this._store.getComments(filmId)));
  }
  ...
  updateMovie(id, data) {
    ...
    const localMovie = _models_movie_model__WEBPACK_IMPORTED_MODULE_0__["default"].clone(data);
...
/* harmony import */ var _utils_date_time__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/date-time */ "./src/utils/date-time.js");
...
class FilmCard extends _abstract_smart_component__WEBPACK_IMPORTED_MODULE_2__["default"] {
  constructor(film) {
    super();
    this._film = film;
  ...
  getTemplate() {
    ...
    const filmDuration = Object(_utils_date_time__WEBPACK_IMPORTED_MODULE_0__["getFormatDuration"])(duration);
    ...
    return (`<article class="film-card">
          ...
          <p class="film-card__description">${Object(_utils_render__WEBPACK_IMPORTED_MODULE_1__["descriptionSlice"])(description)}</p>
...
class FilmPopup extends _abstract_smart_component__WEBPACK_IMPORTED_MODULE_1__["default"] {
      ...
      return acc + `<li class="film-details__comment">
            ...
            <div>
              ...
              <p class="film-details__comment-info">
                ...
                <span class="film-details__comment-day">${Object(_utils_date_time__WEBPACK_IMPORTED_MODULE_0__["getCommentFormatDate"])(date)}</span>
        ...
        <div class="film-details__info">
          ...
          <table class="film-details__table">
            ...
            <tr class="film-details__row">
              ...
              <td class="film-details__cell">${Object(_utils_date_time__WEBPACK_IMPORTED_MODULE_0__["getReleaseDate"])(date)}</td>
            </tr>
            <tr class="film-details__row">
  ...
  submitCommentForm(cb) {
    ...
    cb({emoji: formData.get(`comment-emoji`), text: Object(he__WEBPACK_IMPORTED_MODULE_3__["encode"])(formData.get(`comment`))});
  }
  ...
  onCommentsFormSubmit(cb) {
    this
      ...
      .addEventListener(`keydown`, (evt) => {
        if (evt.ctrlKey && evt.key === _constants__WEBPACK_IMPORTED_MODULE_2__["ENTER_KEY"]) {
...
class Filter extends _abstract_smart_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  getTemplate() {
    ...
    const filters = this._filtersData.reduce((acc, cv) => {
      return `${acc} <a href="#${cv.title}" data-filter="${cv.filterType}" class="main-navigation__item ${this._activeFilter === cv.filterType ? `main-navigation__item--active` : ``}">${cv.title} <span class="main-navigation__item-count">${cv.count}</span></a>`;
    }, initialFilter);
    ...
    this
      ...
      .forEach((item) => {
        item.addEventListener(`click`, (evt) => {
          cb(evt.currentTarget.dataset.filter);
        });
      });
  }
}
...
/***/ "./src/components/main-films-section.js":
/*!**********************************************!*\
  !*** ./src/components/main-films-section.js ***!
  \**********************************************/
/*! exports provided: default */
...
class MainFilmsSection extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  _getTitle() {
    switch (this._dataState) {
      case _constants__WEBPACK_IMPORTED_MODULE_1__["State"].LOADING:
        return `<h2 class="films-list__title">Loading...</h2>`;
      case _constants__WEBPACK_IMPORTED_MODULE_1__["State"].NO_DATA:
...
class MainMenu extends _abstract_smart_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
class MoreButton extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
/***/ "./src/components/most-commented-films-section.js":
/*!********************************************************!*\
  !*** ./src/components/most-commented-films-section.js ***!
  \********************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return MostCommentedFilmsSection; });
/* harmony import */ var _abstract_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-component */ "./src/components/abstract-component.js");


class MostCommentedFilmsSection extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
class Sort extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  getTemplate() {
    const initialSort = ``;
    const sorts = [_constants__WEBPACK_IMPORTED_MODULE_1__["SortType"].BY_DEFAULT, _constants__WEBPACK_IMPORTED_MODULE_1__["SortType"].BY_DATE, _constants__WEBPACK_IMPORTED_MODULE_1__["SortType"].BY_RATING].reduce((acc, cv) => {
...
/* harmony import */ var _utils_date_time__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../utils/date-time */ "./src/utils/date-time.js");
...
class Statistics extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  getTemplate() {
    ...
    const duration = Object(_utils_date_time__WEBPACK_IMPORTED_MODULE_3__["getStatisticsFormatDuration"])(this._data.duration);
  ...
  renderChart() {
    ...
    return new chart_js__WEBPACK_IMPORTED_MODULE_1___default.a(chartElement, {
...
/***/ "./src/components/top-rated-films-section.js":
/*!***************************************************!*\
  !*** ./src/components/top-rated-films-section.js ***!
  \***************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return TopRatedFilmsSection; });
/* harmony import */ var _abstract_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-component */ "./src/components/abstract-component.js");


class TopRatedFilmsSection extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
    return (`<section class="films-list--extra">
...
class UserProfile extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(rank) {
    super();
    this._rank = rank;
  }
...
/*!**************************!*\
  !*** ./src/constants.js ***!
  \**************************/
/*! exports provided: MOST_COMMENTED_FILMS_COUNT, TOP_RATED_FILMS_COUNT, MAIN_FILMS_COUNT_ON_START, MAIN_FILMS_COUNT_BY_BUTTON, ESCAPE_KEY, ENTER_KEY, API_KEY, URL, State, Selector, SortType, FILMCARD_DESCRIPTION_LENGTH, FilterType, STORE_NAME, UserRank */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MOST_COMMENTED_FILMS_COUNT", function() { return MOST_COMMENTED_FILMS_COUNT; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TOP_RATED_FILMS_COUNT", function() { return TOP_RATED_FILMS_COUNT; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MAIN_FILMS_COUNT_ON_START", function() { return MAIN_FILMS_COUNT_ON_START; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MAIN_FILMS_COUNT_BY_BUTTON", function() { return MAIN_FILMS_COUNT_BY_BUTTON; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FILMCARD_DESCRIPTION_LENGTH", function() { return FILMCARD_DESCRIPTION_LENGTH; });
...
class FilterController extends _components_abstract_component__WEBPACK_IMPORTED_MODULE_1__["default"] {
  ...
  _getFiltersData() {
    ...
    return [
      ...
      this._getFilterCount(`History`, _constants__WEBPACK_IMPORTED_MODULE_0__["FilterType"].WATCHED),
      this._getFilterCount(`Watchlist`, _constants__WEBPACK_IMPORTED_MODULE_0__["FilterType"].WATCHLIST),
      this._getFilterCount(`Favorites`, _constants__WEBPACK_IMPORTED_MODULE_0__["FilterType"].FAVORITE),
    ];
  }

  render() {
    const oldFilter = this._filter;
    this._filter = new _components_filter__WEBPACK_IMPORTED_MODULE_2__["default"](this._getFiltersData(), this._moviesModel.getFilter());
    if (oldFilter) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_3__["replace"])(this._filter, oldFilter);
    } else {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_3__["render"])(this._container, this._filter, `afterbegin`);
    }
...
class FooterController {
  ...
  render() {
    ...
    this._footer = new _components_footer__WEBPACK_IMPORTED_MODULE_0__["default"](this._moviesModel.getCountMovies());
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_1__["render"])(this._container, this._footer);
  }
}
...
/* harmony import */ var _components_film_popup__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../components/film-popup */ "./src/components/film-popup.js");
/* harmony import */ var _models_comments_model__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../models/comments-model */ "./src/models/comments-model.js");
/* harmony import */ var _models_movie_model__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../models/movie-model */ "./src/models/movie-model.js");
/* harmony import */ var _models_comment_model__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../models/comment-model */ "./src/models/comment-model.js");
/* harmony import */ var _api_store__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../api/store */ "./src/api/store.js");
/* harmony import */ var _api_provider__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../api/provider */ "./src/api/provider.js");
...
const api = new _api__WEBPACK_IMPORTED_MODULE_2__["default"](_constants__WEBPACK_IMPORTED_MODULE_0__["URL"], _constants__WEBPACK_IMPORTED_MODULE_0__["API_KEY"]);
const store = new _api_store__WEBPACK_IMPORTED_MODULE_8__["default"](_constants__WEBPACK_IMPORTED_MODULE_0__["STORE_NAME"], window.localStorage);
const apiWithProvider = new _api_provider__WEBPACK_IMPORTED_MODULE_9__["default"](api, store);
...
class MovieController {
  constructor(container, onDataChange, onViewChange, onCommentsUpdate) {
    ...
    this._commentsModel = new _models_comments_model__WEBPACK_IMPORTED_MODULE_5__["default"]();
  }

  _changeFilterType(film, filterType) {
    const newFilm = _models_movie_model__WEBPACK_IMPORTED_MODULE_6__["default"].clone(film);
    newFilm[filterType] = !newFilm[filterType];
    if (filterType === _constants__WEBPACK_IMPORTED_MODULE_0__["FilterType"].WATCHED && newFilm.filterType) {
  ...
  _addComment(comment) {
    if (comment.emoji && comment.text) {
      ...
      const newComment = _models_comment_model__WEBPACK_IMPORTED_MODULE_7__["default"].toRAW({
        text: comment.text,
        emoji: comment.emoji,
        date: new Date(),
      });
  ...
  _setDataChangeHandlers(film, component) {
    component.onAddToWatchlist((evt) => {
      this._changeFilterType(film, _constants__WEBPACK_IMPORTED_MODULE_0__["FilterType"].WATCHLIST);
      evt.preventDefault();
    });
    component.onMarkAsWatched((evt) => {
      this._changeFilterType(film, _constants__WEBPACK_IMPORTED_MODULE_0__["FilterType"].WATCHED);
      evt.preventDefault();
    });
    component.onMarkAsFavorite((evt) => {
      this._changeFilterType(film, _constants__WEBPACK_IMPORTED_MODULE_0__["FilterType"].FAVORITE);
      evt.preventDefault();
    });
  }

  _closePopupOnEscape(evt) {
    if (evt.key === _constants__WEBPACK_IMPORTED_MODULE_0__["ESCAPE_KEY"]) {
      this.deleteFilmPopup();
    }
  }

  renderFilmPopup() {
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_1__["render"])(bodyElement, this._filmPopup);
  }
  ...
  render(film) {
    ...
    this._filmCard = new _components_film_card__WEBPACK_IMPORTED_MODULE_3__["default"](this._film);
    this._setDataChangeHandlers(this._film, this._filmCard);
    if (oldFilmCard) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_1__["replace"])(this._filmCard, oldFilmCard);
    } else {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_1__["render"])(this._container, this._filmCard);
    }

    const oldFilmPopup = this._filmPopup;
    this._filmPopup = new _components_film_popup__WEBPACK_IMPORTED_MODULE_4__["default"](this._film);
    this._filmCard.onShowPopup(createFilmPopup);
    if (oldFilmPopup) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_1__["replace"])(this._filmPopup, oldFilmPopup);
...
/* harmony import */ var _api_store__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../api/store */ "./src/api/store.js");
/* harmony import */ var _components_most_commented_films_section__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../components/most-commented-films-section */ "./src/components/most-commented-films-section.js");
/* harmony import */ var _components_top_rated_films_section__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../components/top-rated-films-section */ "./src/components/top-rated-films-section.js");
/* harmony import */ var _components_main_films_section__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../components/main-films-section */ "./src/components/main-films-section.js");
/* harmony import */ var _components_main_menu__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../components/main-menu */ "./src/components/main-menu.js");
/* harmony import */ var _components_user_profile__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../components/user-profile */ "./src/components/user-profile.js");
/* harmony import */ var _components_more_button__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../components/more-button */ "./src/components/more-button.js");
/* harmony import */ var _movie_controller__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./movie-controller */ "./src/controllers/movie-controller.js");
/* harmony import */ var _footer_controller__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./footer-controller */ "./src/controllers/footer-controller.js");
/* harmony import */ var _filter_controller__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./filter-controller */ "./src/controllers/filter-controller.js");
/* harmony import */ var _statistics_controller__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./statistics-controller */ "./src/controllers/statistics-controller.js");
/* harmony import */ var _components_sort__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../components/sort */ "./src/components/sort.js");
...
const api = new _api__WEBPACK_IMPORTED_MODULE_1__["default"](_constants__WEBPACK_IMPORTED_MODULE_15__["URL"], _constants__WEBPACK_IMPORTED_MODULE_15__["API_KEY"]);
const store = new _api_store__WEBPACK_IMPORTED_MODULE_3__["default"](_constants__WEBPACK_IMPORTED_MODULE_15__["STORE_NAME"], window.localStorage);
const apiWithProvider = new _api_provider__WEBPACK_IMPORTED_MODULE_2__["default"](api, store);
const bodyElement = document.querySelector(_constants__WEBPACK_IMPORTED_MODULE_15__["Selector"].BODY);
const headerElement = document.querySelector(_constants__WEBPACK_IMPORTED_MODULE_15__["Selector"].HEADER);
...
class PageController {
  ...
  _renderStatistics() {
    this._statisticsController = new _statistics_controller__WEBPACK_IMPORTED_MODULE_13__["default"](this._moviesModel, this._container);
    this._statisticsController.render();
  }

  _renderUserProfile() {
    const oldUserProfile = this._userProfile;
    this._userProfile = new _components_user_profile__WEBPACK_IMPORTED_MODULE_8__["default"](this._moviesModel.getUserRank());
    if (oldUserProfile) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["replace"])(this._userProfile, oldUserProfile);
    } else {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["render"])(headerElement, this._userProfile);
    }
  }

  _renderMenu() {
    this._mainMenu = new _components_main_menu__WEBPACK_IMPORTED_MODULE_7__["default"]();
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["render"])(this._container, this._mainMenu);
    this._mainMenu.onStatisticsClick(this._toggleStatistics.bind(this));
  }

  _renderFilter() {
    this._filterController = new _filter_controller__WEBPACK_IMPORTED_MODULE_12__["default"](this._moviesModel, this._mainMenu.getElement());
    this._filterController.render();
  }

  _renderFooter() {
    this._footerController = new _footer_controller__WEBPACK_IMPORTED_MODULE_11__["default"](this._moviesModel, bodyElement);
    this._footerController.render();
  }

  _renderSortComponent() {
    const oldSortComponent = this._sortComponent;
    this._sortComponent = new _components_sort__WEBPACK_IMPORTED_MODULE_14__["default"](this._moviesModel.getActiveSort());

    if (oldSortComponent) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["replace"])(this._sortComponent, oldSortComponent);
    } else {
  ...
  _renderFilms(films, container) {
    films.forEach((film) => {
      const movieController = new _movie_controller__WEBPACK_IMPORTED_MODULE_10__["default"](container, this._onDataChange, this._onViewChange, this._onCommentsUpdate);
  ...
  renderMostCommentedSection() {
    this._mostCommentedSection = new _components_most_commented_films_section__WEBPACK_IMPORTED_MODULE_4__["default"]();
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["render"])(this._mainFilmsSection.getElement(), this._mostCommentedSection);
  ...
  _onCommentsUpdate() {
    ...
    if (mostCommentedFilms) {
      ...
      this._mostCommentedSection = new _components_most_commented_films_section__WEBPACK_IMPORTED_MODULE_4__["default"]();
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["replace"])(this._mostCommentedSection, oldMostCommentedSection);
  ...
  renderTopRatedFilms() {
    ...
    this._topRatedSection = new _components_top_rated_films_section__WEBPACK_IMPORTED_MODULE_5__["default"]();
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["render"])(this._mainFilmsSection.getElement(), this._topRatedSection);
  ...
  _renderMainContent() {
    ...
    this._mainFilmsSection = new _components_main_films_section__WEBPACK_IMPORTED_MODULE_6__["default"]();
    if (this._moviesModel.getState() === _constants__WEBPACK_IMPORTED_MODULE_15__["State"].LOADING) {
      this._mainFilmsSection = new _components_main_films_section__WEBPACK_IMPORTED_MODULE_6__["default"](_constants__WEBPACK_IMPORTED_MODULE_15__["State"].LOADING);
      if (oldFilmsSection) {
        Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["replace"])(this._mainFilmsSection, oldFilmsSection);
      } else {
        Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["render"])(this._container, this._mainFilmsSection);
      }
      return;
    }
    if (this._moviesModel.getCountMovies() === 0 || this._moviesModel.getState() === _constants__WEBPACK_IMPORTED_MODULE_15__["State"].NO_DATA) {
      this._mainFilmsSection = new _components_main_films_section__WEBPACK_IMPORTED_MODULE_6__["default"](_constants__WEBPACK_IMPORTED_MODULE_15__["State"].NO_DATA);
      if (oldFilmsSection) {
        Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["replace"])(this._mainFilmsSection, oldFilmsSection);
      } else {
        Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["render"])(this._container, this._mainFilmsSection);
    ...
    let showingFilmsCount = _constants__WEBPACK_IMPORTED_MODULE_15__["MAIN_FILMS_COUNT_ON_START"];
    this._sortComponent.onSortChange(this._moviesModel.updateSort.bind(this._moviesModel));
    this._moreButton = new _components_more_button__WEBPACK_IMPORTED_MODULE_9__["default"]();
    const mainFilms = films.slice(0, showingFilmsCount);
    this._moreButton = new _components_more_button__WEBPACK_IMPORTED_MODULE_9__["default"]();

    if (films.length > showingFilmsCount) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["render"])(this._mainFilmsSection.getFilmsList(), this._moreButton);
    }
    ...
    const showMoreFilms = (evt) => {
      ...
      showingFilmsCount += _constants__WEBPACK_IMPORTED_MODULE_15__["MAIN_FILMS_COUNT_BY_BUTTON"];
...
/* harmony import */ var _utils_render__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/render */ "./src/utils/render.js");
/* harmony import */ var _components_statistics__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/statistics */ "./src/components/statistics.js");
...
filtersData.set(PERIOD_FILTERS.TODAY, addFilter(`Today`, moment__WEBPACK_IMPORTED_MODULE_2___default()().startOf(`day`).toDate()));
filtersData.set(PERIOD_FILTERS.WEEK, addFilter(`Week`, moment__WEBPACK_IMPORTED_MODULE_2___default()().startOf(`week`).toDate()));
filtersData.set(PERIOD_FILTERS.MONTH, addFilter(`Month`, moment__WEBPACK_IMPORTED_MODULE_2___default()().startOf(`month`).toDate()));
filtersData.set(PERIOD_FILTERS.YEAR, addFilter(`Year`, moment__WEBPACK_IMPORTED_MODULE_2___default()().startOf(`year`).toDate()));
...
class StatisticsController {
  ...
  render() {
    ...
    this._statistics = new _components_statistics__WEBPACK_IMPORTED_MODULE_1__["default"](statisticsData, filtersData, this._activeFilter);
    if (oldStatistics) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["replace"])(this._statistics, oldStatistics);
    } else {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["render"])(this._container, this._statistics);
...
/* harmony import */ var _api_provider__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./api/provider */ "./src/api/provider.js");
/* harmony import */ var _api_store__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./api/store */ "./src/api/store.js");
/* harmony import */ var _controllers_page_controller__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./controllers/page-controller */ "./src/controllers/page-controller.js");
/* harmony import */ var _models_movies_model__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./models/movies-model */ "./src/models/movies-model.js");
...
const api = new _api__WEBPACK_IMPORTED_MODULE_1__["default"](_constants__WEBPACK_IMPORTED_MODULE_0__["URL"], _constants__WEBPACK_IMPORTED_MODULE_0__["API_KEY"]);
const store = new _api_store__WEBPACK_IMPORTED_MODULE_3__["default"](_constants__WEBPACK_IMPORTED_MODULE_0__["STORE_NAME"], window.localStorage);
const apiWithProvider = new _api_provider__WEBPACK_IMPORTED_MODULE_2__["default"](api, store);
const moviesModel = new _models_movies_model__WEBPACK_IMPORTED_MODULE_5__["default"]();

const mainElement = document.querySelector(_constants__WEBPACK_IMPORTED_MODULE_0__["Selector"].MAIN);

const pageController = new _controllers_page_controller__WEBPACK_IMPORTED_MODULE_4__["default"](moviesModel, mainElement);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return CommentModel; });
class CommentModel {
  constructor(data) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return MovieModel; });
class MovieModel {
  constructor(data) {
    this.id = parseInt(data.id, 10);
...
class MoviesModel {
  constructor() {
    ...
    this._activeFilter = ``;
    this._state = _constants__WEBPACK_IMPORTED_MODULE_1__["State"].LOADING;
  }
  ...
  setDefaultSort() {
    this._activeSort = _constants__WEBPACK_IMPORTED_MODULE_1__["SortType"].BY_DEFAULT;
  }

  setNoData() {
    this._state = _constants__WEBPACK_IMPORTED_MODULE_1__["State"].NO_DATA;
    this._dataChangeObservers.forEach((cb) => cb());
  }
  ...
  _sortMovies(movies) {
    switch (this._activeSort) {
      case _constants__WEBPACK_IMPORTED_MODULE_1__["SortType"].BY_DATE:
        return movies.sort((a, b) => b.date.getTime() - a.date.getTime());
      case _constants__WEBPACK_IMPORTED_MODULE_1__["SortType"].BY_RATING:
  ...
  setMovies(movies) {
    this._movies = movies;
    this._state = _constants__WEBPACK_IMPORTED_MODULE_1__["State"].DONE;
    if (!this._activeSort) {
      this.setDefaultSort();
    }
    this._dataChangeObservers.forEach((cb) => cb());
  ...
  getTopRatedMovies() {
    ...
    return this._movies.slice().sort((a, b) => b.rating * 10 - a.rating * 10).slice(0, _constants__WEBPACK_IMPORTED_MODULE_1__["TOP_RATED_FILMS_COUNT"]);
  }
  ...
  getMostCommentedMovies() {
    ...
    return this._movies.slice().sort((a, b) => b.getCommentsCount() * 10 - a.getCommentsCount() * 10).slice(0, _constants__WEBPACK_IMPORTED_MODULE_1__["MOST_COMMENTED_FILMS_COUNT"]);
  }
  ...
  setMovie(id, movie, filter) {
    ...
    this._movies = Object(_utils_array__WEBPACK_IMPORTED_MODULE_0__["changeArrayElement"])(this._movies, movie, index);
  ...
  getUserRank() {
    ...
    if (showedFilmsCount < 11) {
      return _constants__WEBPACK_IMPORTED_MODULE_1__["UserRank"].NOVICE;
    }
    if (showedFilmsCount < 21) {
      return _constants__WEBPACK_IMPORTED_MODULE_1__["UserRank"].FAN;
    }
    return _constants__WEBPACK_IMPORTED_MODULE_1__["UserRank"].MOVIE_BUFF;
  }
}
...
/*!****************************!*\
  !*** ./src/utils/array.js ***!
  \****************************/
/*! exports provided: changeArrayElement */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "changeArrayElement", function() { return changeArrayElement; });
...
/*!********************************!*\
  !*** ./src/utils/date-time.js ***!
  \********************************/
/*! exports provided: getStatisticsFormatDuration, getFormatDuration, getReleaseDate, getCommentFormatDate */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getStatisticsFormatDuration", function() { return getStatisticsFormatDuration; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getFormatDuration", function() { return getFormatDuration; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getReleaseDate", function() { return getReleaseDate; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getCommentFormatDate", function() { return getCommentFormatDate; });
...
const getFormatDuration = (duration) => {
  return moment__WEBPACK_IMPORTED_MODULE_0___default.a.duration(duration, `minutes`).format(`h[h] m[m]`);
};
...
const getStatisticsFormatDuration = (duration) => {
  return JSON.parse(moment__WEBPACK_IMPORTED_MODULE_0___default.a.duration(duration, `minutes`).format(`{["h"]:h, ["m"]:m}`));
};
...
/*!*****************************!*\
  !*** ./src/utils/render.js ***!
  \*****************************/
/*! exports provided: createElement, render, replace, descriptionSlice */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "descriptionSlice", function() { return descriptionSlice; });
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../constants */ "./src/constants.js");
...
const descriptionSlice = (string) => {
  return string.length > _constants__WEBPACK_IMPORTED_MODULE_0__["FILMCARD_DESCRIPTION_LENGTH"]
    ? `${string.substr(0, _constants__WEBPACK_IMPORTED_MODULE_0__["FILMCARD_DESCRIPTION_LENGTH"] - 1)}…`
    : string;
};
